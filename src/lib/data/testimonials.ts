...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    text: "Akshay took our rough product brief and shipped a clean, stable platform in weeks. Delivery was fast, structured, and technically solid.",
  ...
  },
  {
    ...
    text: "From backend systems to polished UI, Akshay handled the full stack with ownership. Our team got a reliable launch without hand-holding.",
